...
void EmptyLinkFunctionForGeneratedCodeMRUtilityKit_init() {}
	...
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_MRUtilityKit;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MRUtilityKit()
	{
		if (!Z_Registration_Info_UPackage__Script_MRUtilityKit.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_AMRUKLocalizer_OnComplete__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UMRUKRoomData_OnComplete__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UMRUKSceneData_OnComplete__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_MRUtilityKit(Z_Construct_UPackage__Script_MRUtilityKit, TEXT("/Script/MRUtilityKit"), Z_Registration_Info_UPackage__Script_MRUtilityKit, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xFB2046B0, 0x1200E4BD));
