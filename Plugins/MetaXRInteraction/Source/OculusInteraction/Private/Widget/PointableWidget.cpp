...
#include "Widget/PointableWidget.h"
...
void UIsdkPointableWidget::OnInteractionPointerEvent(FIsdkInteractionPointerEvent PointerEvent)
{
    ...
    TScriptInterface<IIsdkIPointable> IPointable)
{
  ...
  IPointable->GetInteractionPointerEventDelegate().AddUniqueDynamic(
      this, &UIsdkPointableWidget::OnInteractionPointerEvent);
}
