...
UCLASS(
    ...
    meta = (BlueprintSpawnableComponent, DisplayName = "ISDK One Euro Filter"))
class OCULUSINTERACTION_API UIsdkOneEuroFilterDataModifier : public UIsdkHandDataModifier
{
  GENERATED_BODY()

 public:
  UIsdkOneEuroFilterDataModifier();
  ...
  isdk::api::OneEuroHandFilter* GetApiOneEuroHandFilter();

 protected:
  TPimplPtr<isdk::api::helper::FOneEuroHandFilterImpl> OneEuroHandFilterImpl;
};
