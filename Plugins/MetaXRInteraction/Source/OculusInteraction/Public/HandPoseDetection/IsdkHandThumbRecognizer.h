...
class OCULUSINTERACTION_API UIsdkHandThumbRecognizer : public UIsdkHandDigitRecognizer
{
  GENERATED_BODY()
 public:
  UIsdkHandThumbRecognizer();
 ...
 protected:
  ...
  TPimplPtr<isdk::api::helper::FThumbRecognizerImpl> ThumbRecognizerImpl;
};
