...
UCLASS(Abstract)
class OCULUSINTERACTION_API UIsdkWorldSubsystemBase : public UTickableWorldSubsystem
{
  GENERATED_BODY()
};

class OCULUSINTERACTION_API FIsdkWorldSubsystemCollection
    : public FSubsystemCollection<UIsdkWorldSubsystemBase>
{
};
 ...
 */
UCLASS()
class OCULUSINTERACTION_API UIsdkWorldSubsystem : public UIsdkWorldSubsystemBase
{
  GENERATED_BODY()
