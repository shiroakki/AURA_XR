...
#include "IsdkConditionalGroupAll.generated.h"

/**
 * Conditional Group that resolves true if ALL contained conditionals are true
 */
UCLASS(Blueprintable, DefaultToInstanced, Category = InteractionSDK)
class OCULUSINTERACTION_API UIsdkConditionalGroupAll : public UIsdkConditionalGroup
{
  GENERATED_BODY()
 public:
  UIsdkConditionalGroupAll()
  {
