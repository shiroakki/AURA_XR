...
EIsdkHandedness FIsdkOpenXRHelper::ReadHandedness(UMotionControllerComponent* MotionController)
{
  ...
  UE_LOG(LogIsdkDataSourcesOpenXR, Error, TEXT("Motion Controller is null"));
