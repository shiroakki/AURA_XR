...
class AIsdkTestRigActor : public AActor
{
 ...
 public:
  ...
  // Fakes
  UPROPERTY()
  UIsdkFakeHandDataSource* FakeHandDataSource{};
  UPROPERTY()
  UIsdkFakeHandDataSource* FakeControllerDataSource{};
  UPROPERTY()
  UIsdkFakeHmdDataSource* FakeHmdDataSource{};
  UPROPERTY()
  UIsdkFakeTrackingDataSubsystem* FakeTrackingDataSubsystem{};
  UPROPERTY()
  ...
  AIsdkTestRigActor()
  {
    ...
    HandVisuals = CreateDefaultSubobject<UIsdkHandVisualsRigComponent>(TEXT("HandVisuals"));
    ControllerVisuals =
        CreateDefaultSubobject<UIsdkControllerVisualsRigComponent>(TEXT("ControllerVisuals"));
    InputActions = CreateDefaultSubobject<UIsdkInputActionsRigComponent>(TEXT("InputActions"));
    RayInteraction =
        CreateDefaultSubobject<UIsdkRayInteractionRigComponent>(TEXT("RayInteraction"));
    PokeInteraction =
    ...
    const auto HandType = EIsdkHandType::HandLeft;
    ...
    // Fakes
    FakeHandDataSource =
        CreateDefaultSubobject<UIsdkFakeHandDataSource>(TEXT("FakeHandDataSource"));
    FakeControllerDataSource =
        CreateDefaultSubobject<UIsdkFakeHandDataSource>(TEXT("FakeControllerDataSource"));
    FakeHmdDataSource = CreateDefaultSubobject<UIsdkFakeHmdDataSource>(TEXT("FakeHmdDataSource"));
    FakeTrackingDataSubsystem =
        CreateDefaultSubobject<UIsdkFakeTrackingDataSubsystem>(TEXT("FakeTrackingDataSubsystem"));
    FakeTrackingDataSubsystem->HandDataSource = FakeHandDataSource;
    FakeTrackingDataSubsystem->ControllerDataSource = FakeControllerDataSource;
