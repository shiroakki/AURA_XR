      ...
      public IIsdkITrackingDataSubsystem
{
 ...
 public:
  ...
  UPROPERTY()
  UIsdkHandDataSource* HandDataSource{};
  UPROPERTY()
  UIsdkHandDataSource* ControllerDataSource{};
};
...
class UIsdkFakeInteractorStateChangedHandler : public UObject
{
 ...
 public:
  UFUNCTION()
  void HandleStateChanged(FIsdkInteractorStateEvent InteractorState)
  {
...
class UIsdkFakeInteractableStateChangedHandler : public UObject
{
 ...
 public:
  UFUNCTION()
  void HandleStateChanged(FIsdkInteractableStateEvent InteractableState)
  {
    OnStateChange(InteractableState);
  }

  void SetLambda(std::function<void(const FIsdkInteractableStateEvent&)>&& InOnStateChange)
  {
    OnStateChange = std::move(InOnStateChange);
  }
