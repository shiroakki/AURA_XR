...
class OCULUSINTERACTIONEDITOR_API AIsdkTestHandPoseDetectionActor : public AActor
{
 ...
 public:
  ...
  UPROPERTY()
  UIsdkHandVisual* TestTrackedHandVisual{};
  ...
  AIsdkTestHandPoseDetectionActor()
  {
    ...
    TestTrackedHandVisual = CreateDefaultSubobject<UIsdkHandVisual>(FName("TestTrackedHandVisual"));
    ...
    TestTrackedHandVisual->SetMappedBoneNamesAsDefault(EIsdkHandType::HandLeft);
