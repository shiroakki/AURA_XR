...
struct FIsdkColorTransition
{
 ...
 public:
  ...
  static FIsdkColorTransition ImmediateTransitionTo(FIsdkColorState ColorState)
  {
  ...
  FIsdkColorTransition TransitionTo(FIsdkColorState ColorState) const
  {
    FIsdkColorTransition Transition = FIsdkColorTransition();
...
class OCULUSINTERACTIONPREBUILTS_API UIsdkInteractableColorVisual : public UActorComponent
{
 ...
 public:
  ...
  UFUNCTION()
  void HandleStateChange(FIsdkInteractableStateEvent Event);
  ...
  UFUNCTION(BlueprintSetter, Category = InteractionSDK)
  void SetNormalColorState(FIsdkColorState ColorState)
  {
    SetColorState(EIsdkInteractableState::Normal, ColorState);
  }
  UFUNCTION(BlueprintSetter, Category = InteractionSDK)
  void SetHoverColorState(FIsdkColorState ColorState)
  {
    SetColorState(EIsdkInteractableState::Hover, ColorState);
  }
  UFUNCTION(BlueprintSetter, Category = InteractionSDK)
  void SetSelectColorState(FIsdkColorState ColorState)
  {
    SetColorState(EIsdkInteractableState::Select, ColorState);
  }
  UFUNCTION(BlueprintSetter, Category = InteractionSDK)
  void SetDisabledColorState(FIsdkColorState ColorState)
  {
